...
<div class="container">
  <div class="job-inner">
    <div class="job-inner__header">
      <img src="/assets/img/companies/workos.png" alt="WorkOS" class="job-inner__logo">
      <h1 class="job-inner__company">WorkOS</h1>
      <h2 class="job-inner__title">Experienced Product Designer</h2>
      ...
      <div class="job-inner__tags">
        <span class="job-inner__tag">Full-time</span>
        <span class="job-inner__tag">Remote</span>
        <span class="job-inner__tag">Competitive salary</span>
      </div>
